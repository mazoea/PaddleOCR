...
python batch_ts_v3_local.py --input d:\projects\PaddleOCR\___dataset_for_val\dataset_for_val --output d:\projects\issues\jira-515\newst_paddle\_val_output --model_dir %MODEL_PATH% --bbs=1 --threads=15
...
python cmp_ts_val_dataset.py --baseline d:\projects\PaddleOCR\___dataset_for_val --output d:\projects\issues\jira-515\newst_paddle\_val_output
if not errorlevel 0 (
echo Textspotting failed
pause
exit /b 1
